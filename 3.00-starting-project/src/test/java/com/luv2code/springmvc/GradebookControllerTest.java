...
public class GradebookControllerTest {
    ...
    void createValidGradeHttpRequest() throws Exception {
        ...
        gradebookCollegeStudent = studentService.studentInformation(1);
        assertEquals(2, gradebookCollegeStudent.getStudentGrades().getMathGradeResults().size());
    }

    @Test
    void createAValidGradeHttpRequestStudentDoesNotExistEmpyResponse() throws Exception {
    ...
    @Test
    void createANonValidGradeHttpRequestGradeTypeDoesNotExistEmpyResponse() throws Exception {
        MvcResult mvcResult = this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "85.00")
